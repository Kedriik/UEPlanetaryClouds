# -*- coding: utf-8 -*-
"""
Created on Sun Dec  4 12:38:34 2022
...
tcpcurl = 'https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25.pl?file=gfs.t{:02d}z.pgrb2.0p25.f000&var_TCDC=on&leftlon=0&rightlon=360&toplat=90&bottomlat=-90&dir=%2Fgfs.{}%2F{:02d}%2Fatmos'.format(h,d,h)
...
for x in range(cloud_image.width):
    for y in range(cloud_image.height):
        ...
        if current_val < 128:
            ...
            cloud_image.putpixel( (x,y), (255,2*(current_val-128),0) )
cloud_image.save('imagedata\cloudsUE.jpg')
